...
const ContactUs = (props: any) => {
  const dataOfContact = [
    { imageSrc: "/telephoner.png", data: "+21625330717" },
    { imageSrc: "/email.png", data: "gennyconnect.technology@gmail.com" },
    { imageSrc: "/emplacement.png", data: "sahloul,sousse,tunisia" },
  ];
  const pages = [
    { title: "Home" },
    { title: "AboutUs" },
  ...
  return (
    <div id={props.id} className="flex flex-col items-center">
      ...
      <div className=" bg-slate-800 text-white  pt-52 w-full">
        <div className="flex flex-row  justify-between items-center p-8">
          <div className="flex flex-col justify-between items-center w-64 p-6 h-60">
            <Image
            ...
            <p className=" font-serif text-base mb-4">
              <span className="ml-2"></span>Our weekely Newsletter full of
              inspiration, proadcasts, trebds & news
            </p>
          ...
          <div className="flex flex-col justify-between items-center w-72 p-6 h-48 mb-12">
            <h2>Contact us</h2>
            <div>
              <ul className="flex flex-col justify-between h-24">
                {dataOfContact.map((contact, index) => {
                  return (
